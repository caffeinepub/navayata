...
export class Backend implements backendInterface {
    ...
    async getFee(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getFee();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async modifyProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.modifyProduct(await to_candid_Product_n19(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeProduct(arg0: string): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async setFee(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setFee(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function to_candid_Product_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Product): Promise<_Product> {
